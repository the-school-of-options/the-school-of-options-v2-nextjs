...
export const LightHeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center py-14 md:py-16 px-4 overflow-hidden bg-white">
      ...
      <div className="container relative z-10 max-w-4xl mx-auto text-center">
        {/* Badge */}
        <div className="mb-8">
          <div className="bg-gradient-purple px-6 py-3 rounded-full text-sm font-bold text-white shadow-orange inline-block">
            <div className="flex flex-col sm:flex-row items-center gap-2">
              <span className="whitespace-nowrap text-black">🟢 FREE 3-Hour Masterclass</span>
              <span className="whitespace-nowrap bg-background/20 px-3 py-1 rounded-full border border-primary-foreground/30">
                <span className="text-black">by </span> 
                <span className="text-white font-extrabold">kundan kishore</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="mb-8 text-center">
        ...
        <div className="mb-6">
          <Button 
            ...
            className="bg-[rgb(255,103,25)] text-black px-8 py-6 text-lg font-semibold rounded-xl shadow-orange hover:scale-105 transition-all duration-300"
          >

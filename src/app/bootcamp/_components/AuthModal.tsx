...
import { Mail, Lock, Eye, EyeOff, Loader, User as UserIcon, Phone, CheckCircle, ArrowLeft } from "lucide-react";
...
export const AuthModal = ({ isOpen, onClose, onSuccess, useSignupWithoutVerification = false, onAutoRegister }: AuthModalProps) => {
  ...
  const { login, register, registerWithoutVerification, forgotPassword } = useAuth();
              ...
              {showForgotPassword && (
                <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-semibold text-black">Reset your password</h3>
                  </div>
